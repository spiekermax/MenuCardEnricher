...
class OrderFragment : Fragment(R.layout.fragment_order) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dish1 = Dish("Flafel", 55.0, DishDetail("Homos", ByteBuffer.allocate(0)))
        val dish2 = Dish("Shish", 100.0, DishDetail("Chicken", ByteBuffer.allocate(0)))
        val dish3 = Dish("Yalanji", 25.0, DishDetail("Grapes Leaf", ByteBuffer.allocate(0)))
        val dish4 = Dish("Shawrma", 40.0, DishDetail("chicken Wrap", ByteBuffer.allocate(0)))
        val dish5 = Dish("kobby", 50.0, DishDetail("dough with meat", ByteBuffer.allocate(0)))
